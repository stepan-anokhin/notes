...
**Определение 3.2**: Будем говорить, что множество $A$ *замкнуто относительно набора оперций* $F$, если $A$ замкнуто относительно каждой операции $f \in F$, а именно $\forall f \in F: f(A^{T\_f})\subseteq A$. 

**Определение 3.3**: *Замыканием* множества $A\subseteq X$ относительно операций $f\_1,...,f\_n$ будем называть наименьшее множество $[A]\_{f\_1,...,fn}^{\*}\subseteq X$ замкнутое относительно $f\_1,...,f\_n$ и содержащее $A$: $\forall B \subseteq X$, если $A \subseteq B$ и $B$ замкнуто относительно $f\_1, ...., f\_n$, то $[A]\_{f\_1,...,fn}^{\*} \subseteq B$. В случае, когда набор функций $f\_1,...,f\_n$ ясен из контекста, будем просто писать $[A]^{\*}$
