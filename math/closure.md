...
Для удобства изложения нам понадобится еще следующее полезное понятие:
...
Заметим, что из $O\_4$ следует, что множество $A$ замкнуто относительно $F$ тогда и только тогда, когда 
$\langle A \rangle\_F = \varnothing$

**Определение $O\_5$ (Свойство)**: *Свойством* элементов множества $X$ будет называть любую функцию 
