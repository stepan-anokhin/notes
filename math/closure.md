...
**Теорема**: Пусть задано произвольное множество $X$, свойство $P$ и набор операций $F$, сохранящией $P$. 
Тогда для произвольного подмножества $G \subseteq X$, если $G \subseteq True(P)$, то и $[G]_F \subseteq True(P)$.
