...
*Последовательностью* $\mathbf{x} = x\_1, \thinspace x\_2, \thinspace \ldots, \thinspace x\_{\alpha}, \thinspace \ldots$ 
...
арностей мы будем писать $\tau\_f, \tau\_g$. Если функции индексированы 
