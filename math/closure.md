...
*Последовательностью* $x = \set{ x\_1, \quad x\_2, \quad \ldots, \quad x\_{\alpha}, \quad \ldots }$ будем называть 
любую функцию $f:\tau \rightarrow X$. Само ординальное число $\tau$ мы будем называть *длиной* или *числом элементов* 
