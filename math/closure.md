...
**Соглашение 2.1**: Если в некотором контексте речь будет идти о разных функциях $f, g$, то для различения соответствующих сигнатур мы будем использовать индексы $T\_f, T\_g$. Если функции индексированы $f\_1, f\_2, ..., f\_i, ...$, то для различения соответствующих сигнатур мы будем использовать те же индексы: $T\_1, T\_2, ..., T\_i, ...$.
