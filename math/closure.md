...
Для начала заметим, что $G\_\alpha \cap G\_\beta = \varnothing$ при $\alpha \neg = \beta$. Действительно, предположим, 
что $\alpha < \beta$, тогда $G\_\alpha \in G\_{<\beta}^\*$, но так, как $G\_\beta = \langle G\_{<\beta}^\* \rangle$, то
$G\_\beta$ не содержит элементов $G\_{<\beta}^\*$ и, значит, элементов $G\_\alpha$. 
