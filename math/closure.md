...
$F$, определенных на $X$, если $F(A) \subseteq A$. *Замыканием* множества $A$ относительно набора операций $F$ будем
называть наименьшее множество, содержащее $A$ и замкнутое относительно набора операций $F$. Замыкание множества $A$
относительно набора операций $F$ будем обозначать через $[A]_F$ или просто $[A]$ в случае, когда множество $F$ ясно 
из контекста. 
