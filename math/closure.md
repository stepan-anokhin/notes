...
**Определение 2 (Операции)**: Пусть $\tau$ - произвольный кардинал. Тогда $\tau$-*арной* операцией 
...
Если в определенном контексте контексте речь будет идти о разных операциях $f, g$, то для обозначения соответствующих 
...
**Определение 3 (Замыкание)**: Будем говорить, что множество $A \subseteq X$ *замкнуто* относительное набора операций
...
Из Определения 3 непосредственно вытекает, что множество $A$ замкнуто тогда и только тогда, когда оно равно своему 
замыканию: $A = [A]$. Это в свою очередь влечёт, что для любого $A$ имеет место равенство $[[A]]=[A]$.  

**Определение 4 (Пополнение)**: *Пополнением* $\langle A \rangle\_F$ множества $A$ c помощью набора операций $F$ будем 
...
**Определение 5 (Свойство)**: *Свойством* элементов множества $X$ будет называть любую функцию 
...
$P$, если область истинности $Tr(P)$ замкнута относительно $F$: $F(True(P)) \subseteq True(P)$. 
