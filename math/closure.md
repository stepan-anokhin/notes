...
**Теорема**: Пусть задано произвольное множество $X$, набор операций $F$ и свойство $P$ на $X$. 
Пусть $G \subset True(P)$ - некоторое подмножество $X$ на котором выполняется свойство 
$P$. Если набор операций $F$ сохраняют свойство $P$, то $[G]_F \subseteq True(P)$.
