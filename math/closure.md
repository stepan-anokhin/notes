...
Множество всех таких последовательностей будем обозначать $X^{\tau}$. Ординальные числа из $\alpha \in \tau$ будем 
называть *индексами* соответсвующих элементов последовательности. 
