...
> Всё нижеследующее доказывается гораздо проще. Пусть множество $A$ замкнуто относительно набора
> операций $F$: $[A]_F = A$, и пусть дано множество $G \subseteq A$. Тогда $[G]_F \subseteq A$. Утверждение
> очевидно, поскольку, по определению, замыкание $[G]_F$ - это наименьшее такое замкнутое множество, 
> а, зничит, оно содержится в $A$. Удивительно, что я этого сразу не заметил. Всё нижеследующее - 
> это просто упражнение по уточнению математических определений и использованию трансфинитной индукции.
> Ну и поучительная история о том, как, не заметив очевидной вещи, можно проделать лишнюю работу.
> Впрочем, любой опыт полезен.
